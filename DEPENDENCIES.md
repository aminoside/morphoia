...
| Existing Python package | Prototype parser/runtime/CLI | Unified 40-test suite and CLI smoke PASS | Pre-existing package remains MIT; ADR-017 separates its version from Engine |
...
| REUSE 6.2.0 plus Poetry Core 2.4.1 build backend | License-metadata validation | Separate hash-locked build/runtime installs and 159-file lint PASS | Development-only; exact inputs inventoried, vulnerability audit remains NOT_RUN |
