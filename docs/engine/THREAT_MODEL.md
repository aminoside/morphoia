...
| CI credential theft | immutable Action SHAs, least privilege, no checkout credential retained, hash-locked wheels | workflow inspection `PASS`; corrective SHA `8b41fa8435e5812b5bd10ae92e35878d9803e0bc` passed Engine/report runs `31581879387`/`31581879373`, then merge SHA `7715a7f7897a3058473732915e372b9835317d17` passed the `engine` push run `31582827407`; earlier missing-`pdftotext` failures were dependency evidence, not credential exposure |
