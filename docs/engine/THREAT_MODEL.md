...
| CI credential theft | immutable Action SHAs, least privilege, no checkout credential retained, hash-locked wheels | workflow inspection `PASS`; corrective SHA `8b41fa8435e5812b5bd10ae92e35878d9803e0bc` passed all Engine jobs in run `31581879387` and the report job in run `31581879373`; earlier missing-`pdftotext` failures were dependency evidence, not credential exposure |
