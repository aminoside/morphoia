# P2c v2 public preregistration

Status: `FROZEN_BEFORE_EXECUTION`

Author: Dr Olivier Ami

This directory preregisters a new P2c campaign over the same private three
P2a parents and four resource profiles as the frozen v1 diagnostic. It contains
no v2 result, source identity, P2a work identifier, source hash, Drive locator,
...
The campaign version is `2.0.0`. It is deliberately distinct from algorithm
...
No P2c v2 outcome can emit `V`, certify a solid, satisfy G1, or receive any
